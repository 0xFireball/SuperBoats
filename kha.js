...
sprites_PlayerBoat.prototype = $extend(sprites_GreenBoat.prototype,{
	...
	,movement: function() {
		...
		this.attacking = n4_NGame.keys.pressed(["F","M"]);
	}
...
var sprites_projectiles_Projectile = function(X,Y) {
	...
	this.damageScale = 0.041666666666666664;
...
states_HelpState.prototype = $extend(n4_NState.prototype,{
	...
	,create: function() {
		...
		this.emitter = new n4_effects_particles_NParticleEmitter(200);
		this.add(this.emitter);
		var pbt = new n4e_ui_NEText(20,n4_NGame.height * 0.65,"use the arrow keys or wasd to move. use f or m to shoot.",26);
		pbt.screenCenter(n4_util_NAxes.X);
		this.add(pbt);
		if(this["transient"]) {
	...
	,update: function(dt) {
		...
		if(!this["transient"] && n4_NGame.keys.justPressed(["F"])) {
			n4_NGame.switchState(Registry.MS);
		}
		n4_NState.prototype.update.call(this,dt);
	}
...
states_IntroState.prototype = $extend(n4_NState.prototype,{
	...
	,create: function() {
		...
		this.preloader = new util_PreloaderSprite();
...
states_MenuState.prototype = $extend(n4_NState.prototype,{
	...
	,update: function(dt) {
		...
		if(n4_NGame.keys.justPressed(["F"])) {
			this.startGame();
		}
...
states_PlayState.prototype = $extend(n4_NState.prototype,{
	...
	,update: function(dt) {
		...
		if(n4_NGame.keys.justPressed(["ESC"])) {
			n4_NGame.switchState(Registry.MS);
		}
		n4_NState.prototype.update.call(this,dt);
...
var util_PreloaderSprite = function() {
	this.cycleCount = 10;
	this.maxJ = 20;
	this.maxI = 20;
	this.j = 1;
	this.i = 1;
	n4_entities_NSprite.call(this,0,0);
	this.set_y(this.set_x(-100));
};
$hxClasses["util.PreloaderSprite"] = util_PreloaderSprite;
util_PreloaderSprite.__name__ = true;
util_PreloaderSprite.__super__ = n4_entities_NSprite;
util_PreloaderSprite.prototype = $extend(n4_entities_NSprite.prototype,{
	i: null
	,j: null
	,maxI: null
	,maxJ: null
	...
	,doIteration: function() {
		this.makeGraphic(this.i,this.j);
		this.j++;
		if(this.j >= this.maxI) {
			this.j = 1;
			this.i++;
	...
	,__class__: util_PreloaderSprite
});
